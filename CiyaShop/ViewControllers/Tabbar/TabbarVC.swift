...
class TabbarVC: BaseViewController,UITabBarControllerDelegate {
    ...
    func getHomeData() {
        ...
        CiyaShopAPISecurity.homeData(params) { (success, message, responseData) in
            ...
            deactiveAccountAlertTitle =  jsonReponse["delete_account_alert_title"].stringValue
            deactiveAccountAlertMessage =  jsonReponse["delete_account_alert_message"].stringValue
